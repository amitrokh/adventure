...
DEVS_TO_WAIT = []
DEVS_TO_WAIT_FINN    = ['/dev/serial/by-id/usb-FTDI_FT232R_USB_UART_AL00CIPJ-if00-port0', 
                        '/dev/serial/by-id/usb-Yujin_Robot_iClebo_Kobuki_kobuki_A601D9PH-if00-port0']
DEVS_TO_WAIT_JAKE    = ['/dev/serial/by-id/usb-FTDI_FT232R_USB_UART_A504ECS0-if00-port0', 
                        '/dev/serial/by-id/usb-Yujin_Robot_iClebo_Kobuki_kobuki_AH02B8IH-if00-port0']
DEVS_TO_WAIT_GUNTER  = []
DEVS_TO_WAIT_BMO     = [] 

if (ROS_HOSTNAME == "finn"):
    DEVS_TO_WAIT = DEVS_TO_WAIT_FINN
if (ROS_HOSTNAME == "jake"):
    DEVS_TO_WAIT = DEVS_TO_WAIT_JAKE
if (ROS_HOSTNAME == "gunter"):
    DEVS_TO_WAIT = DEVS_TO_WAIT_GUNTER
if (ROS_HOSTNAME == "bmo"):
    DEVS_TO_WAIT = DEVS_TO_WAIT_BMO
